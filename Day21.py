...
p = Person('Ivan', 'Marinkovic', 250, 'Serbia', 'Belgrade')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
print(p.person_info())
# output
# Ivan Marinkovic is 250 years old. He lives in Belgrade, Serbia
...
class Person:
      def __init__(self, firstname='Ivan', lastname='Marinkovic', age=250, country='Serbia', city='Belgrade'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
