...
# We target content from a website using HTML tags, classes or/and ids. Let us import the requests and BeautifulSoup module.
...
# If you run this code, you can see that the extraction is half done. 
# You can continue doing it because it is part of exercise 1. 
