...
# 
# Many applications provide API end points. Some examples of API such as the cat's breed API https://api.thecatapi.com/v1/breeds
# 
...
# This site has been deployed on Heroku free dyno and in some months may not work because of high request. Support this work to make the server run all the time.
...
# A complete list of HTTP status code can be found https://www.webfx.com/web-development/glossary/http-status-codes/

# Header Fields
# As you have seen in the above, header lines provide information about the request or response, or about the object sent in the message body.
