...
# In this section, we will see how we use Python for the web. 
# There are many Python web frame works. 
# Django and Flask are the most popular ones. Today, we will see how to use Flask for web development.
# 
# Flask
...
# check Day23.py for windows ... below two lines are for linux
...
# We created a project director named python_for_web. 
# Inside the project we created a virtual environment venv which could be any name but I prefer to call it venv. 
# Then we activated the virtual environment. We used pip freeze to check the installed packages in the project directory. 
# The result of pip freeze was empty because a package was not installed yet.
# 
# Now, let's create app.py file in the project directory and write the following code. In (>>>...\python_for_web\venv\app.py)
...
# To run the flask application, write python app.py in the main flask application directory. Means cd to venv and then execute app.py
# 
# After you run python app.py check local host 5000.
# paste in browser localhot:5000 example >>  http://192.168.100.xx:5000
# Additional route is About
# Access it through localhost:5000/about

# How about if we want to render an HTML file instead of string? 
...
#
#Creating templates
#Create the HTML files inside templates folder. templates folder inside project folder, actually inside venv folder (>>>...\python_for_web\venv\templates)
#
...
# Let us create additional page which handle form data. You can call it any name, I like to call it post.html.
...
# 
# In the post, route we will use GET and POST method alternative depending on the type of request, check how it looks in the code below. 
...
# Now, lets handle static file. Create a folder called static in the project director and create a folder called css. 
# Inside css folder create main.css. Your main. css file will be linked to the layout.html.
# 
...
# Create an account on heroku and install the heroku CLI for you machine. After installing heroku write the following command
# Login to Heroku
# open git bash terminal and >>
# asabeneh@Asabeneh:~$ heroku login
# heroku: Press any key to open up the browser to login or q to exit:

# Let's see the result by clicking any key from the keyboard. 
# When you press any key from you keyboard it will open the heroku login page and click the login page. 
...
# After this step you will get an application